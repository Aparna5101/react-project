...
import Treatements from "./component/TreatmentsAvail/TreatAvailable";
import Products from "./component/Products/ProductAvail";
  ...
  return (
    <div className="App">
      <Router>
        ...
        <Route exact path="/treatements" component={Treatements} />

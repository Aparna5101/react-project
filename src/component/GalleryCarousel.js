...
import Img1 from '../photos/facilities1.jpeg';
...
class GalleryCarousel extends Component {
    ...
    render() { 
        return (
         ...
         <Card.ImgOverlay>
             <Card.Title ><h3>OPD</h3></Card.Title>
         ...
         <Carousel.Item>
             ...
             <Card.ImgOverlay>
                 <Card.Title><h3>Panchakarma Theatres</h3></Card.Title>
         ...
         <Carousel.Item>
             <Card className="text-danger">
             <Card.Img src={Img3} alt="Card image" height="500" width="10000%"/>
             <Card.ImgOverlay>
                 <Card.Title><h3>Pharmacy</h3></Card.Title>  
             </Card.ImgOverlay>
             </Card>
             </Carousel.Item>
         ...
         <Carousel.Item>
             ...
             <Card.ImgOverlay>
                 <Card.Title><h3>Consultation</h3></Card.Title>  
             </Card.ImgOverlay>
             </Card>
             </Carousel.Item>    
         <Carousel.Item>
             ...
             <Card.ImgOverlay>
                 <Card.Title><h3>Care Taker</h3></Card.Title>  
             </Card.ImgOverlay>
             </Card>
         </Carousel.Item>
         <Carousel.Item>
             ...
             <Card.ImgOverlay>
                 <Card.Title className="text-danger"><h3>Home Sevices</h3></Card.Title>  
             </Card.ImgOverlay>
             </Card>
         </Carousel.Item>

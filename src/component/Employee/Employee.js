...
class Employee extends Component {
  ...
  onSubmit1(e) {
    ...
    Axios.post(`${API_URI}/admin/assign_doctor`, ass_doc)
      .then((response) => {
        if (response.data == "Yes   ")
          alert("Patient Assigned to the Consultant");
        else alert("Patient Already assigned!");
        this.setState({
          patient_id: "",
          doctor_id: "",
        });
  ...
  onSubmit2(e) {
    ...
    Axios.post(`${API_URI}/doctor/register`, ass_doc)
      .then((response) => {
        return response.data;
      })
      .catch((err) => console.log(err));
  ...
  onSubmit3(e) {
    ...
    Axios.post(`${API_URI}/admin/bill`, data)
      .then((response) => {
        return response.data;
      })
      .catch((err) => console.log(err));
  ...
  onSubmit4(e) {
    ...
    Axios.post(`${API_URI}/doctor/delete`, data)
      .then((response) => {
        return response.data;
      })
      .catch((err) => console.log(err));
  ...
  onSubmit5(e) {
    ...
    Axios.post(`${API_URI}/doctor/update_sal`, data)
      .then((response) => {
        return response.data;
      })
      .catch((err) => console.log(err));
  ...
  componentDidMount() {
    Axios.get(`${API_URI}/employee/profile`, {
      headers: {
            ...
            <div className="container mr-3">
              ...
              >
                <form noValidate onSubmit={this.onSubmit2}>
                  <div className="col-sm-6">
                    <h2 className="text-primary">Add New Consultant</h2>
                  </div>
                  <br />
            ...
            <div className="container mr-3">
              ...
              >
                <form noValidate onSubmit={this.onSubmit5}>
                  <div className="col-sm-6">
                    <h2 className="text-primary">Update Consultant Salary</h2>
                  </div>
                  <br />
                  <div className="form-group">
                    <label htmlFor="name">Doctor ID</label>

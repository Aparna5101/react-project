                    ...
                    <table className="table col-md-6">
                      <tbody>
                        ...
                        <tr>
                          <td>Total </td>
                          <td>
                            {Number(this.state.misc_charge) +
                              Number(this.state.room_charge) +
                              Number(this.state.operation_charge) +
                              Number(this.state.medicine_cost)}
                          </td>
                        </tr>
                      </tbody>
                    </table>
              ...
              >
                ...
                <div className="card-body card-body-cascade text-center">
                  ...
                  <p className="card-text">
                    The doctor currently assigned to the patient
                  </p>
                </div>
              </div>
            </div>

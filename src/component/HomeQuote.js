        ...
        <div className="row">
            ...
            <Card bg="primary" text="white" style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text className="text-white">
                  ...
                  Developement Cell, Operation Theater and a Check-Up center.
                </Card.Text>
                <br />
              </Card.Body>
            </Card>
          ...
          <div className="col-md-3 ml-3 mr-3">
            <Card bg="success" text="white" style={{ width: "18rem" }}>
              <Card.Header>Best Hospitality Award</Card.Header>
              <Card.Body>
                <Card.Title>
                  Awarded to be Best Hospital in TamilNadu
                </Card.Title>
                <Card.Text>
                  We are overwhelmed by the support our patients provide us and
                  you made us the best in TamilNadu!
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
          <div className="col-md-3 ml-3 mr-2">
            <Card bg="warning" text="white" style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Researcher Dr. Subhashish Karmakar found a new cure for
